...
idxTemp2["rets28_city"]="Address City";
idxTemp2["rets28_county"]="Address County";
idxTemp2["rets28_stateorprovince"]="Address State";
idxTemp2["rets28_direction"]="Address Street Direction";
idxTemp2["rets28_streetname"]="Address Street Name";
idxTemp2["rets28_streetnumber"]="Address Street Number";
idxTemp2["rets28_subdivision"]="Address Subdivision Name";
idxTemp2["rets28_unitnumber"]="Address Unit Number";
idxTemp2["rets28_postalcode"]="Address Zip Code";
...
idxTemp2["rets28_landstyle"]="Landstyle";
idxTemp2["rets28_landtype"]="Landtype";
...
idxTemp2["rets28_locationdescription"]="Locationdescription";
idxTemp2["rets28_lotsize"]="Lot Size";
idxTemp2["rets28_yearbuilt"]="Year Built";
idxTemp2["rets28_zoning"]="Zoning";
idxTemp2["rets28_utilitiesonsite"]="Utilitiesonsite";
idxTemp2["rets28_utlitiesandfuel"]="Utlitiesandfuel";
...
idxTemp2["rets28_roadfrontage"]="Road Frontage Depth";
...
idxTemp2["rets28_securityandmisc"]="Securityandmisc";
...
idxTemp2["rets28_waterandsewer"]="Waterandsewer";
idxTemp2["rets28_waterfeatures"]="Waterfeatures";
...
idxTemp2["rets28_watertype"]="Watertype";
idxTemp2["rets28_windowsandwindowtrtmnt"]="Windowsandwindowtrtmnt";
idxTemp2["rets28_windowtrtmnt"]="Windowtrtmnt";
idxTemp2["rets28_propertysubtype"]="Property Sub-type";
idxTemp2["rets28_propertytype"]="Property Type";
idxTemp2["rets28_projectphase"]="Projectphase";
idxTemp2["rets28_property_id"]="Property_id";
idxTemp2["rets28_age"]="Property Age";
idxTemp2["rets28_propertyformat"]="Property Format";
...
idxTemp2["rets28_accessandtransportation"]="Accessandtransportation";
...
idxTemp2["rets28_assessmentdesc"]="Assessment Description";
idxTemp2["rets28_attachmentcount"]="Attachment Count";
idxTemp2["rets28_attachmentyn"]="Attachment Y/n";
idxTemp2["rets28_availablewithlease"]="Availablewithlease";
idxTemp2["rets28_backupoffersacceptedyn"]="Back-up Offers Accepted Y/n";
idxTemp2["rets28_gasexpense"]="Gas Average Per Month";
idxTemp2["rets28_gasmeters"]="Gas Meters";
idxTemp2["rets28_marinaamenities"]="Marinaamenities";
idxTemp2["rets28_stories"]="Level";
idxTemp2["rets28_licensedrealtoryn"]="Licensed Realtor Y/n";
idxTemp2["rets28_limitedserviceyn"]="Limited Service Y/n";
idxTemp2["rets28_listagentkey"]="List Agent Key";
idxTemp2["rets28_listingboardid"]="Listing Agent Board Id";
idxTemp2["rets28_listingagentid"]="Listing Agent Id";
idxTemp2["rets28_listingagentname"]="Listingagentname";
idxTemp2["rets28_listingofficeid"]="Listing Agent Office Id";
idxTemp2["rets28_listagentagentid"]="Listing Agent Uid";
idxTemp2["rets28_listingdetail"]="Listingdetail";
idxTemp2["rets28_listingfirmid"]="Listing Firm Id";
idxTemp2["rets28_listofficeofficeid"]="Listing Office";
idxTemp2["rets28_listofficeaffilliation"]="Listing Office Affiliation";
...
idxTemp2["rets28_clearspan"]="Clear Span";
...
idxTemp2["rets28_dateexpirationextended"]="Date Expiration Extended";
idxTemp2["rets28_statuschangedate"]="Date History Status";
idxTemp2["rets28_dateleased"]="Date Leased";
idxTemp2["rets28_listdate"]="Date Listed";
idxTemp2["rets28_datelistingconfirmed"]="Date Listing Confirmed";
idxTemp2["rets28_datelistingunconfirmed"]="Date Listing Unconfirmed";
idxTemp2["rets28_datenewlisting"]="Date New Listing";
idxTemp2["rets28_dateownershiptransfer"]="Date Ownership Transfer";
...
idxTemp2["rets28_modificationtimestamp"]="Date Recap";
...
idxTemp2["rets28_documentsanddisclosures"]="Documentsanddisclosures";
...
idxTemp2["rets28_equipmentandappliances"]="Equipmentandappliances";
idxTemp2["rets28_estimatevalueyn"]="Estimate Of Value Y/n";
idxTemp2["rets28_exclusiveagency"]="Exclusive Agency";
idxTemp2["rets28_exteriorfeatures"]="Exteriorfeatures";
idxTemp2["rets28_exteriorfinish"]="Exteriorfinish";
...
idxTemp2["rets28_garageandcarstorage"]="Garageandcarstorage";
idxTemp2["rets28_bathspartial"]="Half-baths";
idxTemp2["rets28_harbormasteryn"]="Harbormaster Y/n";
...
idxTemp2["rets28_interiorimprovements"]="Interiorimprovements";
...
idxTemp2["rets28_masterbath"]="Masterbath";
...
idxTemp2["rets28_pooldescription"]="Pooldescription";
idxTemp2["rets28_pool"]="Pool Description";
idxTemp2["rets28_poolfeatures"]="Poolfeatures";
...
idxTemp2["rets28_siteimprovements"]="Siteimprovements";
idxTemp2["rets28_slipamenities"]="Slipamenities";
idxTemp2["rets28_slipdraft"]="Slip Draft";
idxTemp2["rets28_slipstorageyn"]="Slip Storage Y/n";
...
idxTemp2["rets28_officeidx"]="Office Idx";
idxTemp2["rets28_officesqft"]="Office Sqft";
idxTemp2["rets28_officestatus"]="Office Status";
...
idxTemp2["rets28_howsolddesc"]="How Sold Description";
idxTemp2["rets28_incluinmonthlyleaseamnt"]="Incluinmonthlyleaseamnt";
idxTemp2["rets28_insuranceexpense"]="Insurance Expenses";
idxTemp2["rets28_leaseinfo"]="Leaseinfo";
idxTemp2["rets28_leaseoption"]="Lease Option Y/n/u";
idxTemp2["rets28_leaseprovisions"]="Leaseprovisions";
idxTemp2["rets28_leaseterms"]="Leaseterms";
idxTemp2["rets28_currentlyleasedyn"]="Lease Y/n";
idxTemp2["rets28_legaldescription"]="Legal Description";
idxTemp2["rets28_maintefeecovers"]="Maintefeecovers";
idxTemp2["rets28_maintenanceexpense"]="Maintenance Expenses";
idxTemp2["rets28_maintexpensespaidby"]="Maintenance Expenses Paid By";
idxTemp2["rets28_maintfeecovers"]="Maintfeecovers";
...
idxTemp2["rets28_monthlyrent"]="Total Income";
idxTemp2["rets28_totalleases"]="Total Leases";
...
idxTemp2["rets28_tenantexpenses"]="Tenantexpenses";
idxTemp2["rets28_titleinsuranceavailableyn"]="Title Insurance Available Y/n";
idxTemp2["rets28_originallistingfirmname"]="Original Listing Firm Name";
idxTemp2["rets28_originallistprice"]="Original Price";
idxTemp2["rets28_originalsellingfirmname"]="Original Selling Firm Name";
...
idxTemp2["rets28_rentalcompensation"]="Rental Compensation";
...
idxTemp2["rets28_pendingagentagentid"]="Pending Agent Id";
idxTemp2["rets28_pendingofficeofficeid"]="Pending Agent Office";
idxTemp2["rets28_prospectsexcludedyn"]="Name Prospect Y/n";
idxTemp2["rets28_nonrepcommdesc"]="Non-representative Commission De";
idxTemp2["rets28_possession"]="Possession";
idxTemp2["rets28_previouslistprice"]="Previous List Price";
idxTemp2["rets28_variableratecommyn"]="Variable Rate Commission Y/n";
	return arraytolist(arrR,'');
	</cfscript>
</cffunction>
</cfoutput>
