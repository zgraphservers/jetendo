...
<cffunction name="makeTableStat" localmode="modern" access="remote" roles="member">
	<cfargument name="chartData" type="array" required="yes">
	<cfargument name="columnData" type="array" required="yes">
	<cfargument name="numBreaks" type="number" required="yes">
	<cfscript>
	...
	<script>
		...
		function(){
			...
			var svg = d3.select("###chartName#"),
				width = 330 /*+svg.attr("width")*/,
				height = 330/*+svg.attr("height")*/,
...
<cffunction name="makeBarGraph" localmode="modern" access="remote">
	...
	<div style="float:left;">
		<svg id="#chartName#" width="500" height="400">
		</svg>
	</div>
	<script>
	function #chartName#loadLineCharts(){
		// parse the date / time
